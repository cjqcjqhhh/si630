...
class MyTaskPVP(PVP):
    ...
    def get_parts(self, example: InputExample):
        ...
        if self.pattern_id == 0:
            return ["you are", self.mask, text_a], []
        elif self.pattern_id == 1:
            return [self.mask, 'you', text_a], []
        elif self.pattern_id == 2:
            return ['what a', self.mask, text_a], []
        elif self.pattern_id == 3:
            return [text_a, 'just like the', self.mask],[]
        elif self.pattern_id == 4:
            return [text_a, 'make it', self.mask],[]
        elif self.pattern_id == 5:
            return [self.mask, 'is going on', text_a],[]
        elif self.pattern_id == 6:
            return ['I have a huge', self.mask, text_a],[]
        elif self.pattern_id == 7:
            return [text_a, 'for your', self.mask], []
        elif self.pattern_id == 8:
            return [self.mask, 'everything to do', text_a],[]
        elif self.pattern_id == 9:
            return ["I hope you", self.mask, text_a], []
        else:
    ...
    def verbalize(self, label) -> List[str]:
        ...
        # elif self.pattern_id == 2:
        #     return MyTaskPVP.VERBALIZER_2[label]
        # elif self.pattern_id == 3:
        #     return MyTaskPVP.VERBALIZER_3[label]
        # elif self.pattern_id == 4:
        #     return MyTaskPVP.VERBALIZER_4[label]
        # elif self.pattern_id == 5:
        #     return MyTaskPVP.VERBALIZER_5[label]
        # elif self.pattern_id == 6:
        #     return MyTaskPVP.VERBALIZER_6[label]
        # elif self.pattern_id == 7:
        #     return MyTaskPVP.VERBALIZER_7[label]
        # elif self.pattern_id == 8:
        #     return MyTaskPVP.VERBALIZER_8[label]
        # elif self.pattern_id == 9:
        #     return MyTaskPVP.VERBALIZER_9[label]
        # else:
        #     raise ValueError("No pattern implemented for id {}".format(self.pattern_id))
